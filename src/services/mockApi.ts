  ...
  if (!localStorage.getItem(STORAGE_KEYS.BOOKS)) {
    const defaultBooks: Book[] = [
      ...
      },
      {
        ...
        publishedYear: 1954,
        genre: 'Fantasy',
        description: 'An epic high-fantasy novel that is often considered the greatest fantasy work of all time.',
      ...
      },
      {
        ...
        description: 'A science fiction novel about the son of a political family navigating political intrigue.',
      ...
      },
      {
        ...
        coverImage: 'https://images.unsplash.com/photo-1618365908648-e71bd5716cba?w=300&h=400&fit=crop',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
